                ...
                <div class="topbar">
                    ...
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="../../assets/imgs/profile.png" alt="User" class="user-avatar" width="40" height="40">
                        </a>
                    ...
                    <table class='table table-striped table-bordered'>
                        ...
                        <tbody>
                            ...
                            if ($result_id_compte->num_rows === 1) {
                                ...
                                $query_courriers = "SELECT * FROM courriers WHERE destinataire = ?";
                                ...
                                if ($result_courriers->num_rows > 0) {
                                    while ($row = $result_courriers->fetch_assoc()) {
                                        // Vérifier si le courrier est traité
                                        if ($row['traite'] == 0) { // Si le courrier n'est pas traité, affichez-le dans le tableau
                                            echo "<tr>";
                                    ...
                                    echo "<tr><td colspan='6'>Aucun courrier trouvé pour cet utilisateur</td></tr>";
                                }
                            } else {
